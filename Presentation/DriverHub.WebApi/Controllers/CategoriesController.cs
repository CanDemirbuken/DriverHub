...
using DriverHub.Application.Features.CategoryFeatures.Commands.RemoveCategory;
using DriverHub.Application.Features.CategoryFeatures.Commands.UpdateCategory;
using DriverHub.Application.Features.CategoryFeatures.Queries.GetAllCategory;
...
public sealed class CategoriesController(IMediator mediator) : BaseController(mediator)
{
    ...
    [ProducesResponseType(typeof(ApiResponse<GetCategoryByIdQueryResponse>), StatusCodes.Status404NotFound)]
    ...
    [ProducesResponseType(typeof(ApiResponse<CreateCategoryCommandResponse>), StatusCodes.Status400BadRequest)]
    [ProducesResponseType(typeof(ApiResponse<CreateCategoryCommandResponse>), StatusCodes.Status409Conflict)]
