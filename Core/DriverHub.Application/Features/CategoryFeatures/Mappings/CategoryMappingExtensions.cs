...
{
    public static GetAllCategoryQueryResponse ToGetAllResponse(this Category category)
    {
    ...
    public static GetCategoryByIdQueryResponse ToGetByIdResponse(this Category category)
    {
